...
| Reversal / Body Press / Infestation | `ddabadb780cf1bdfba8c1d8d03b1855067c0ae83`, `42496dbd9`, `7d26f57fe` and later bind fixes | A | Initial calculation and bind patches absent | Port Reversal's Flail scaling, Body Press's Defense calculation, and final coherent bind behavior rather than only Infestation's first tag change | HP power bands; Attack/Defense-stage isolation; residual damage, messages, four trapping moves, switch restriction |
